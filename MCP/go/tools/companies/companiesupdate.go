...
func CompaniesupdateHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.UpdateHrisCompanyResponse
...
func CreateCompaniesupdateTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_hris_companies_id",
		mcp.WithDescription("Update Company"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    CompaniesupdateHandler(cfg),
	}
}
