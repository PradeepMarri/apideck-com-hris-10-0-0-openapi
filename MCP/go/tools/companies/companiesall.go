...
func CompaniesallHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GetHrisCompaniesResponse
...
func CreateCompaniesallTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_hris_companies",
		mcp.WithDescription("List Companies"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    CompaniesallHandler(cfg),
	}
}
