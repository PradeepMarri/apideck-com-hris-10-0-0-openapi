...
func CompaniesoneHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GetHrisCompanyResponse
...
func CreateCompaniesoneTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_hris_companies_id",
		mcp.WithDescription("Get Company"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    CompaniesoneHandler(cfg),
	}
}
