...
func CompaniesdeleteHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/hris/companies/%s%s", cfg.BaseURL, id, queryString)
		...
		var result models.DeleteHrisCompanyResponse
...
func CreateCompaniesdeleteTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_hris_companies_id",
		mcp.WithDescription("Delete Company"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    CompaniesdeleteHandler(cfg),
	}
}
