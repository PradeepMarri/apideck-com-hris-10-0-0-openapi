...
func EmployeepayrollsallHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/hris/payrolls/employees/%s%s", cfg.BaseURL, employee_id, queryString)
		...
		var result models.GetEmployeePayrollsResponse
...
func CreateEmployeepayrollsallTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_hris_payrolls_employees_employee_id",
		mcp.WithDescription("List Employee Payrolls"),
		...
		mcp.WithObject("filter", mcp.Description("Apply filters")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    EmployeepayrollsallHandler(cfg),
	}
}
