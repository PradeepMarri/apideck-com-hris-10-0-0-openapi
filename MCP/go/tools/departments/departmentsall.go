...
func DepartmentsallHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GetDepartmentsResponse
...
func CreateDepartmentsallTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_hris_departments",
		mcp.WithDescription("List Departments"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    DepartmentsallHandler(cfg),
	}
}
