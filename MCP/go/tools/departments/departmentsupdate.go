...
func DepartmentsupdateHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.Department
		...
		url := fmt.Sprintf("%s/hris/departments/%s%s", cfg.BaseURL, id, queryString)
		...
		var result models.UpdateDepartmentResponse
...
func CreateDepartmentsupdateTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_hris_departments_id",
		mcp.WithDescription("Update Department"),
		...
		mcp.WithString("parent_id", mcp.Description("Input parameter: Parent ID")),
		...
		mcp.WithString("name", mcp.Description("Input parameter: Department name")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    DepartmentsupdateHandler(cfg),
	}
}
