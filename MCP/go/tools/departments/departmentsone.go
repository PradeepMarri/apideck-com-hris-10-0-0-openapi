...
func DepartmentsoneHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GetDepartmentResponse
...
func CreateDepartmentsoneTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_hris_departments_id",
		mcp.WithDescription("Get Department"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    DepartmentsoneHandler(cfg),
	}
}
