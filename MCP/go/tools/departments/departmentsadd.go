...
func DepartmentsaddHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/hris/departments%s", cfg.BaseURL, queryString)
		...
		var result models.CreateDepartmentResponse
...
func CreateDepartmentsaddTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_hris_departments",
		mcp.WithDescription("Create Department"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    DepartmentsaddHandler(cfg),
	}
}
