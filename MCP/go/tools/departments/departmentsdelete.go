...
func DepartmentsdeleteHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.DeleteDepartmentResponse
...
func CreateDepartmentsdeleteTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_hris_departments_id",
	...
	return models.Tool{
		Definition: tool,
		Handler:    DepartmentsdeleteHandler(cfg),
	}
}
