...
func EmployeesoneHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GetEmployeeResponse
...
func CreateEmployeesoneTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_hris_employees_id",
		mcp.WithDescription("Get Employee"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    EmployeesoneHandler(cfg),
	}
}
