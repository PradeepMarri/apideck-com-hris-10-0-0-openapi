...
func EmployeesdeleteHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/hris/employees/%s%s", cfg.BaseURL, id, queryString)
		...
		var result models.DeleteEmployeeResponse
...
func CreateEmployeesdeleteTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_hris_employees_id",
		mcp.WithDescription("Delete Employee"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    EmployeesdeleteHandler(cfg),
	}
}
