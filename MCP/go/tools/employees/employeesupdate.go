...
func EmployeesupdateHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.UpdateEmployeeResponse
...
func CreateEmployeesupdateTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_hris_employees_id",
		mcp.WithDescription("Update Employee"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    EmployeesupdateHandler(cfg),
	}
}
