...
func EmployeesallHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GetEmployeesResponse
...
func CreateEmployeesallTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_hris_employees",
		mcp.WithDescription("List Employees"),
		...
		mcp.WithObject("sort", mcp.Description("Apply sorting")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    EmployeesallHandler(cfg),
	}
}
