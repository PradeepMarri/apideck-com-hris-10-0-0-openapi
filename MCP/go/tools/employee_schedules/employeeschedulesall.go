...
func EmployeeschedulesallHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/hris/schedules/employees/%s%s", cfg.BaseURL, employee_id, queryString)
		...
		var result models.GetEmployeeSchedulesResponse
...
func CreateEmployeeschedulesallTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_hris_schedules_employees_employee_id",
		mcp.WithDescription("List Employee Schedules"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    EmployeeschedulesallHandler(cfg),
	}
}
