...
func PayrollsallHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/hris/payrolls%s", cfg.BaseURL, queryString)
		...
		var result models.GetPayrollsResponse
...
func CreatePayrollsallTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_hris_payrolls",
		mcp.WithDescription("List Payroll"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    PayrollsallHandler(cfg),
	}
}
