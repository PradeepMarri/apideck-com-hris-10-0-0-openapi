...
func PayrollsoneHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/hris/payrolls/%s%s", cfg.BaseURL, payroll_id, queryString)
		...
		var result models.GetPayrollResponse
...
func CreatePayrollsoneTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_hris_payrolls_payroll_id",
		mcp.WithDescription("Get Payroll"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    PayrollsoneHandler(cfg),
	}
}
