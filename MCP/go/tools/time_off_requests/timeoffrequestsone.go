...
func TimeoffrequestsoneHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GetTimeOffRequestResponse
...
func CreateTimeoffrequestsoneTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_hris_time-off-requests_id",
		mcp.WithDescription("Get Time Off Request"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    TimeoffrequestsoneHandler(cfg),
	}
}
