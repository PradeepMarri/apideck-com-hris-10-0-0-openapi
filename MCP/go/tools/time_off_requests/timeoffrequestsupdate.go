...
func TimeoffrequestsupdateHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.UpdateTimeOffRequestResponse
...
func CreateTimeoffrequestsupdateTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_hris_time-off-requests_id",
		mcp.WithDescription("Update Time Off Request"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    TimeoffrequestsupdateHandler(cfg),
	}
}
