...
func TimeoffrequestsdeleteHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/hris/time-off-requests/%s%s", cfg.BaseURL, id, queryString)
		...
		var result models.DeleteTimeOffRequestResponse
...
func CreateTimeoffrequestsdeleteTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_hris_time-off-requests_id",
		mcp.WithDescription("Delete Time Off Request"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    TimeoffrequestsdeleteHandler(cfg),
	}
}
