...
func TimeoffrequestsallHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GetTimeOffRequestsResponse
...
func CreateTimeoffrequestsallTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_hris_time-off-requests",
		mcp.WithDescription("List Time Off Requests"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    TimeoffrequestsallHandler(cfg),
	}
}
